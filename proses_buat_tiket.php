...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $sql_customer = "INSERT INTO ms_customers (customer_id_number, full_name, address, phone_number, email) 
                         VALUES ('$customerIdNumber', '$fullName', '$address', '$phoneNumber', '$email')";
        mysqli_query($conn, $sql_customer);
    ...
    if ($last_customer_id) {
        ...
        $sql_ticket = "INSERT INTO tr_tickets (ticket_code, customer_id, title, description, created_by_user_id, current_owner_user_id)
                       VALUES ('$ticketCode', '$last_customer_id', '$jenisGangguan', '$deskripsiGangguan', '$createdByUserId', '$createdByUserId')";
